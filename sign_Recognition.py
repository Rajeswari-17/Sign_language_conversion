...
# Start capturing video from the USB webcam
cap = cv2.VideoCapture(0)  # 0 is the default camera for USB webcams
if not cap.isOpened():
...
while True:
    ...
    frame = cv2.flip(frame, -1)  # Flip the frame vertically (optional)
